...
public class ItemSpriteSheet {
	...
	public static final int BONE_THROWER    = UNCOLLECTIBLE+11;
	static{
	...
	public static final int WOOD_SWORD      = WEP_TIER1+0;
