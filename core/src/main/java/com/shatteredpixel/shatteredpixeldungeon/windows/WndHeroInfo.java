	...
	public WndHeroInfo( HeroClass cl ){
		...
		switch (cl){
			...
			case ENGINEER:
				...
				break;
			case PILLAGER:
				tabIcon = new ItemSprite(ItemSpriteSheet.SATCHEL, null);
				break;
		}
			...
			switch (cls){
				...
				case HUNTRESS:
					icons = new Image[]{ new ItemSprite(ItemSpriteSheet.SPIRIT_BOW),
							Icons.GRASS.get(),
							new ItemSprite(ItemSpriteSheet.WOOD_SWORD),
							new ItemSprite(ItemSpriteSheet.SCROLL_ISAZ)};
					break;
				case DUELIST:
				...
				case ENGINEER:
					...
					break;
				case PILLAGER:
					icons = new Image[]{ new ItemSprite(ItemSpriteSheet.RING_MIMIC),
							new ItemSprite(ItemSpriteSheet.SATCHEL),
							new ItemSprite(ItemSpriteSheet.DINNERKNIFE),
							new ItemSprite(ItemSpriteSheet.SCROLL_ISAZ)};
					break;
			}
			for (Image im : icons) {
