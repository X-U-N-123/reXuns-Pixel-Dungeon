...
public abstract class KindOfBoomerang extends MissileWeapon {
	...
	public static class CircleBack extends Buff {
		...
		private KindOfBoomerang boomerang;
		...
		public void setup(KindOfBoomerang boomerang, int thrownPos, int returnPos, int returnDepth, int returnBranch){
		...
		public void restoreFromBundle(Bundle bundle) {
			...
			boomerang = (KindOfBoomerang) bundle.get(BOOMERANG);
