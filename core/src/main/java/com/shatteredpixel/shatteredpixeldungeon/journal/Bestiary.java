...
public enum Bestiary {
	...
	static {
		...
		ALLY.addEntities(MirrorImage.class, PrismaticImage.class,
				...
				ShadowClone.ShadowAlly.class, SmokeBomb.NinjaLog.class, SpiritHawk.HawkAlly.class, PowerOfMany.LightAlly.class, Detonator.DetonationMob.class, Landmark.LandMark.class);
